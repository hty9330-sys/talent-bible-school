...
const reasons = ["출석", "성경암송", "영어학습", "예배태도", "친구도움", "과제완료", "찬양참여", "특별칭찬", "기타"];
...
function registerServiceWorker() {
  ...
  navigator.serviceWorker.register("./service-worker.js?v=20260630-06").catch(() => {});
}
